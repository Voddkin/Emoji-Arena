...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const el_btn_play_modes = document.getElementById('btn-play-modes');
if (el_btn_play_modes) el_btn_play_modes.addEventListener('click', () => {
        document.getElementById('play-modes-modal').classList.remove('hidden');
    });

    const el_btn_close_play_modes = document.getElementById('btn-close-play-modes');
if (el_btn_close_play_modes) el_btn_close_play_modes.addEventListener('click', () => {
        document.getElementById('play-modes-modal').classList.add('hidden');
    });

    const el_btn_collection = document.getElementById('btn-collection');
if (el_btn_collection) el_btn_collection.addEventListener('click', () => showScreen(screens.COLLECTION));
    const el_btn_shop = document.getElementById('btn-shop');
if (el_btn_shop) el_btn_shop.addEventListener('click', () => showScreen(screens.SHOP));

    const el_btn_quests = document.getElementById('btn-quests');
if (el_btn_quests) el_btn_quests.addEventListener('click', () => {
        renderQuests();
        document.getElementById('quests-overlay').classList.remove('hidden');
    });
    const el_btn_close_quests = document.getElementById('btn-close-quests');
if (el_btn_close_quests) el_btn_close_quests.addEventListener('click', () => {
        document.getElementById('quests-overlay').classList.add('hidden');
    });

    const el_btn_achievements = document.getElementById('btn-achievements');
if (el_btn_achievements) el_btn_achievements.addEventListener('click', () => {
        renderAchievements();
        document.getElementById('achievements-overlay').classList.remove('hidden');
    });
    const el_btn_close_achievements = document.getElementById('btn-close-achievements');
if (el_btn_close_achievements) el_btn_close_achievements.addEventListener('click', () => {
        document.getElementById('achievements-overlay').classList.add('hidden');
    });


    const el_btn_roguelike = document.getElementById('btn-roguelike');
if (el_btn_roguelike) el_btn_roguelike.addEventListener('click', () => {
    ...
    const el_btn_abandon_run = document.getElementById('btn-abandon-run');
if (el_btn_abandon_run) el_btn_abandon_run.addEventListener('click', () => {
...
if (el_btn_leaderboard) el_btn_leaderboard.addEventListener('click', () => {
        renderLeaderboard();
        showScreen(screens.LEADERBOARD);
    });

    const el_btn_play_endless = document.getElementById('btn-play-endless');
if (el_btn_play_endless) el_btn_play_endless.addEventListener('click', () => {
        document.getElementById('play-modes-modal').classList.add('hidden');
    ...
    const el_btn_settings = document.getElementById('btn-settings');
if (el_btn_settings) el_btn_settings.addEventListener('click', () => {
        document.getElementById('settings-overlay').classList.remove('hidden');
    });
    const el_btn_close_settings = document.getElementById('btn-close-settings');
if (el_btn_close_settings) el_btn_close_settings.addEventListener('click', () => {
        document.getElementById('settings-overlay').classList.add('hidden');
    });
    const el_btn_reset_data = document.getElementById('btn-reset-data');
if (el_btn_reset_data) el_btn_reset_data.addEventListener('click', resetSaveData);
    ...
    const el_btn_close_pack = document.getElementById('btn-close-pack');
if (el_btn_close_pack) el_btn_close_pack.addEventListener('click', () => {
        document.getElementById('pack-opening-overlay').classList.add('hidden');
        saveProfile();
    });

    // Collection Logic
    const el_btn_toggle_forge = document.getElementById('btn-toggle-forge');
if (el_btn_toggle_forge) el_btn_toggle_forge.addEventListener('click', () => {
    ...
    // Forge Buttons
    const el_btn_cancel_forge = document.getElementById('btn-cancel-forge');
if (el_btn_cancel_forge) el_btn_cancel_forge.addEventListener('click', () => {
        document.getElementById('forge-modal').classList.add('hidden');
    });

    // Play Modes Actions
    const el_btn_play_adventure = document.getElementById('btn-play-adventure');
if (el_btn_play_adventure) el_btn_play_adventure.addEventListener('click', () => {
        currentMatchMode = 'adventure';
        startBattle(true);
    });

    const el_btn_play_ranked = document.getElementById('btn-play-ranked');
if (el_btn_play_ranked) el_btn_play_ranked.addEventListener('click', () => {
    ...
    const el_btn_play_casual = document.getElementById('btn-play-casual');
if (el_btn_play_casual) el_btn_play_casual.addEventListener('click', () => {
        currentMatchMode = 'casual';
        startBattle(true);
    });

    // Battle actions
    const el_btn_end_turn = document.getElementById('btn-end-turn');
if (el_btn_end_turn) el_btn_end_turn.addEventListener('click', endTurn);

    const el_btn_hero_power = document.getElementById('btn-hero-power');
if (el_btn_hero_power) el_btn_hero_power.addEventListener('click', useHeroPower);
